...
public class DatabaseManager {
    // MySQL connection settings (configure via env vars)
    private static final String URL = System.getenv().getOrDefault("DB_URL", "jdbc:mysql://localhost:3306/mediconnect");
